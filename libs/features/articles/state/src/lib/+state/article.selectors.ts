...
export const selectAllCategoriesAsOptions = createSelector(selectArticleState, (state: ArticleState) => {
  const categoryOptions: Option[] = state.categories.map(category => ({
...
export const selectArticlesOfSelectedCategory = createSelector(selectArticleState, (state: ArticleState) => (
  state.articlesOfSelectedCategory
));

export const selectSelectedCategory = createSelector(selectArticleState, (state: ArticleState) => (
  state.articlesOfSelectedCategory[0]?.category
));
