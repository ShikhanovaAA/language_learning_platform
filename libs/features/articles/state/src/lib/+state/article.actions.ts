...
export const CreateArticleFail = createAction('[Article] Create Article Fail', props<{ errors: HttpErrorResponse }>());
...
export const GetArticlesFail = createAction('[Article] Get Articles Fail', props<{ errors: HttpErrorResponse }>());
...
export const GetArticlesByCategoryIdFail = createAction('[Article] Get Articles By Category Id Fail', props<{ errors: HttpErrorResponse }>());
...
export const GetArticleByIdFail = createAction('[Article] Get Article By Id Fail', props<{ errors: HttpErrorResponse }>());
...
export const CreateCategoryFail = createAction('[Article] Create Category Fail', props<{ errors: HttpErrorResponse }>());
...
export const GetCategoriesFail = createAction('[Article] Get Categories Fail', props<{ errors: HttpErrorResponse }>());
...
export const AddArticleToStudiedFail = createAction('[Article] Add Article To Studied Fail', props<{ errors: HttpErrorResponse }>());
