...
const LabelTopPositionTemplate: StoryFn<FormFieldComponent> = (args: FormFieldComponent) => ({
  props: args,
  template: `
...
const LabelBottomPositionTemplate: StoryFn<FormFieldComponent> = (args: FormFieldComponent) => ({
  props: args,
  template: `
...
const LabelLeftPositionTemplate: StoryFn<FormFieldComponent> = (args: FormFieldComponent) => ({
  props: args,
  template: `
