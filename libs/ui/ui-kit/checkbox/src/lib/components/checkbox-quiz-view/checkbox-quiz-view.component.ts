...
@Component({
  selector: 'llp-checkbox-quiz-view',
  templateUrl: './checkbox-quiz-view.component.html',
  styleUrls: ['./checkbox-quiz-view.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => CheckboxQuizViewComponent),
      multi: true,
    },
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CheckboxQuizViewComponent extends ControlComponent<string> {
  @Input()
  label = '';
